...
def main():
    ...
    table_total_cost = (table_quantity_1 * table_price_1) + (table_quantity_2 * table_price_2)
    ...
    sofa_total_cost = (sofa_quantity_1 * sofa_price_1) + (sofa_quantity_2 * sofa_price_2)
    ...
    chair_total_cost = (chair_quantity_1 * chair_price_1) + (chair_quantity_2 * chair_price_2) + (chair_quantity_3 * chair_price_3)
